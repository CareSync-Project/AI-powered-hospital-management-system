...
router.post('/vitals', validate({ body: clinicalVitalSchema.extend({ hospitalId: uuid.optional(), appointmentId: uuid.optional().nullable() }) }), asyncHandler(clinicalController.patientVitalCreate));
