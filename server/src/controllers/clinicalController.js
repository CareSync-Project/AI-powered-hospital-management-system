...
export const clinicalController={
 ...
 async patientVitalCreate(req,res){res.status(201).json({success:true,data:await vitalService.create(getPatientProfileId(req.auth),{...req.body,source:'PATIENT',verificationStatus:'UNVERIFIED',recordedByUserId:req.auth.userId})})},
