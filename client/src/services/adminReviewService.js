...
export const adminReviewService={
 patients:()=>api.get('/admin/patients'), nurses:()=>api.get('/admin/nurses'), analytics:()=>api.get('/admin/analytics'), appointments:(filters)=>api.get(`/admin/appointments${query(filters)}`), reports:(filters)=>api.get(`/admin/reports${query(filters)}`),
